        ...
        for bag = 0, 4 do
            ...
            for slot = 1, size do
                ...
                if frame then
                    ...
                    texture:SetTexture("Interface\\AddOns\\Deli_Ui\\img\\bagbg2.tga")
...
button:SetNormalTexture("Interface\\AddOns\\Deli_Ui\\img\\bigbag")
...
bbMain:SetNormalTexture("Interface\\AddOns\\Deli_Ui\\img\\bagslots2x1.tga")
...
bbMain:SetPushedTexture("Interface\\AddOns\\Deli_Ui\\img\\bagslots2x1.tga")
...
bbMain:SetHighlightTexture("Interface\\AddOns\\Deli_Ui\\img\\bagslots2x1.tga")
--Get the texture object and set its coordinates
...
-----------------Arrow to the left of the Main Bag icon-----------------
  ...
  bbLeftArrow:SetNormalTexture("Interface\\AddOns\\Deli_Ui\\img\\bagslots2x1.tga")
...
bbArrow:SetNormalTexture("Interface\\AddOns\\Deli_Ui\\img\\bagslots2x1.tga")
...
lb1:SetNormalTexture("Interface\\AddOns\\Deli_Ui\\img\\bagslots2x1.tga")
...
--Set the button's pushed texture
lb1:SetPushedTexture("Interface\\AddOns\\Deli_Ui\\img\\bagslots2x1.tga")
--Get the texture object and set its coordinates
local lb1PushedTexture = lb1:GetPushedTexture()
lb1PushedTexture:SetTexCoord(422/512, 475/512, 65/128, 118/128)
--Set the button's highlight texture
lb1:SetHighlightTexture("Interface\\AddOns\\Deli_Ui\\img\\bagslots2x1.tga")
--Get the texture object and set its coordinates
...
lb1:SetFrameLevel(CharacterBag0Slot:GetFrameLevel() + 2)
lb1:SetFrameStrata("HIGH")
...
lb2:SetNormalTexture("Interface\\AddOns\\Deli_Ui\\img\\bagslots2x1.tga")
...
--MainBagNormalTexture:SetHeight(25)
--Set the button's pushed texture
lb2:SetPushedTexture("Interface\\AddOns\\Deli_Ui\\img\\bagslots2x1.tga")
--Get the texture object and set its coordinates
local lb2PushedTexture = lb2:GetPushedTexture()
lb2PushedTexture:SetTexCoord(422/512, 475/512, 65/128, 118/128)
--Set the button's highlight texture
lb2:SetHighlightTexture("Interface\\AddOns\\Deli_Ui\\img\\bagslots2x1.tga")
--Get the texture object and set its coordinates
...
lb2:SetFrameLevel(CharacterBag1Slot:GetFrameLevel() + 2)
lb2:SetFrameStrata("HIGH")
...
lb3:SetNormalTexture("Interface\\AddOns\\Deli_Ui\\img\\bagslots2x1.tga")
...
--MainBagNormalTexture:SetHeight(25)
--Set the button's pushed texture
lb3:SetPushedTexture("Interface\\AddOns\\Deli_Ui\\img\\bagslots2x1.tga")
--Get the texture object and set its coordinates
local lb3PushedTexture = lb3:GetPushedTexture()
lb3PushedTexture:SetTexCoord(422/512, 475/512, 65/128, 118/128)
--Set the button's highlight texture
lb3:SetHighlightTexture("Interface\\AddOns\\Deli_Ui\\img\\bagslots2x1.tga")
--Get the texture object and set its coordinates
...
lb3:SetFrameLevel(CharacterBag2Slot:GetFrameLevel() + 2)
lb3:SetFrameStrata("HIGH")
...
lb4:SetNormalTexture("Interface\\AddOns\\Deli_Ui\\img\\bagslots2x1.tga")
...
--MainBagNormalTexture:SetHeight(25)
--Set the button's pushed texture
lb4:SetPushedTexture("Interface\\AddOns\\Deli_Ui\\img\\bagslots2x1.tga")
--Get the texture object and set its coordinates
local lb4PushedTexture = lb4:GetPushedTexture()
lb4PushedTexture:SetTexCoord(422/512, 475/512, 65/128, 118/128)
--Set the button's highlight texture
lb4:SetHighlightTexture("Interface\\AddOns\\Deli_Ui\\img\\bagslots2x1.tga")
--Get the texture object and set its coordinates
...
lb4:SetScript("OnClick", function(self, button, down)
  ...
  -- Add this line to move lb3 in front of CharacterBag2Slot
lb4:SetFrameLevel(CharacterBag3Slot:GetFrameLevel() + 2)
lb4:SetFrameStrata("HIGH")
...
kr:SetNormalTexture("Interface\\AddOns\\Deli_Ui\\img\\bagslots2key.tga")
...
--MainBagNormalTexture:SetHeight(25)
--Set the button's pushed texture
kr:SetPushedTexture("Interface\\AddOns\\Deli_Ui\\img\\bagslots2key.tga")
--Get the texture object and set its coordinates
local krPushedTexture = kr:GetPushedTexture()
krPushedTexture:SetTexCoord(68/128, 122/128, 63/128, 124/128)
--Set the button's highlight texture
kr:SetHighlightTexture("Interface\\AddOns\\Deli_Ui\\img\\bagslots2key.tga")
--Get the texture object and set its coordinates
