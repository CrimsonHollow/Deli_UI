...
mbHelp:SetNormalTexture("Interface\\AddOns\\Deli_Ui\\img\\uimicromenu2x.tga")
...
mbHelp:SetPushedTexture("Interface\\AddOns\\Deli_Ui\\img\\uimicromenu2x.tga")
--Get the texture object and set its coordinates
...
mbHelp:SetHighlightTexture("Interface\\AddOns\\Deli_Ui\\img\\uimicromenu2x.tga")
--Get the texture object and set its coordinates
...
--Set the button's normal texture
mbPvP:SetNormalTexture("Interface\\AddOns\\Deli_Ui\\img\\uimicromenu2x.tga")
--Get the texture object and set its coordinates
local PvPNormalTexture = mbPvP:GetNormalTexture()
PvPNormalTexture:SetTexCoord(0/256, 37/256, 269/512, 319/512)
--Set the button's pushed texture
mbPvP:SetPushedTexture("Interface\\AddOns\\Deli_Ui\\img\\uimicromenu2x.tga")
--Get the texture object and set its coordinates
local PvPPushedTexture = mbPvP:GetPushedTexture()
PvPPushedTexture:SetTexCoord(161/256, 197/256, 161/512, 211/512)
--Set the button's highlight texture
mbPvP:SetHighlightTexture("Interface\\AddOns\\Deli_Ui\\img\\uimicromenu2x.tga")
--Get the texture object and set its coordinates
...
-- --Set the button's normal texture
-- mbShop:SetNormalTexture("Interface\\AddOns\\Deli_Ui\\img\\uimicromenu2x.tga")
-- --Get the texture object and set its coordinates
-- local ShopNormalTexture = mbShop:GetNormalTexture()
-- ShopNormalTexture:SetTexCoord(41/256, 78/256, 161/512, 211/512)
-- --Set the button's pushed texture
-- mbShop:SetPushedTexture("Interface\\AddOns\\Deli_Ui\\img\\uimicromenu2x.tga")
-- --Get the texture object and set its coordinates
-- local ShopPushedTexture = mbShop:GetPushedTexture()
-- ShopPushedTexture:SetTexCoord(0/256, 38/256, 431/512, 482/512)
-- --Set the button's highlight texture
-- mbShop:SetHighlightTexture("Interface\\AddOns\\Deli_Ui\\img\\uimicromenu2x.tga")
-- --Get the texture object and set its coordinates
...
-- --Set the button's normal texture
-- mbLFT:SetNormalTexture("Interface\\AddOns\\Deli_Ui\\img\\uimicromenu2x.tga")
-- --Get the texture object and set its coordinates
-- local LFTNormalTexture = mbLFT:GetNormalTexture()
-- LFTNormalTexture:SetTexCoord(0/256, 38/256, 161/512, 211/512)
-- --Set the button's pushed texture
-- mbLFT:SetPushedTexture("Interface\\AddOns\\Deli_Ui\\img\\uimicromenu2x.tga")
-- --Get the texture object and set its coordinates
-- local LFTPushedTexture = mbLFT:GetPushedTexture()
-- LFTPushedTexture:SetTexCoord(41/256, 78/256, 107/512, 157/512)
-- --Set the button's highlight texture
-- mbLFT:SetHighlightTexture("Interface\\AddOns\\Deli_Ui\\img\\uimicromenu2x.tga")
-- --Get the texture object and set its coordinates
...
-- --Set the button's normal texture
-- mbEBC:SetNormalTexture("Interface\\AddOns\\Deli_Ui\\img\\uimicromenu2x.tga")
-- --Get the texture object and set its coordinates
-- local EBCNormalTexture = mbEBC:GetNormalTexture()
-- EBCNormalTexture:SetTexCoord(82/256, 119/256, 325/512, 374/512)
-- --Set the button's pushed texture
-- mbEBC:SetPushedTexture("Interface\\AddOns\\Deli_Ui\\img\\uimicromenu2x.tga")
-- --Get the texture object and set its coordinates
-- local EBCPushedTexture = mbEBC:GetPushedTexture()
-- EBCPushedTexture:SetTexCoord(82/256, 119/256, 378/512, 429/512)
-- --Set the button's highlight texture
-- mbEBC:SetHighlightTexture("Interface\\AddOns\\Deli_Ui\\img\\uimicromenu2x.tga")
-- --Get the texture object and set its coordinates
...
--Set the button's normal texture
mbSpellBook:SetNormalTexture("Interface\\AddOns\\Deli_Ui\\img\\uimicromenu2x.tga")
--Get the texture object and set its coordinates
...
--Set the button's pushed texture
mbSpellBook:SetPushedTexture("Interface\\AddOns\\Deli_Ui\\img\\uimicromenu2x.tga")
--Get the texture object and set its coordinates
...
--Set the button's highlight texture
mbSpellBook:SetHighlightTexture("Interface\\AddOns\\Deli_Ui\\img\\uimicromenu2x.tga")
--Get the texture object and set its coordinates
...
-- Set the button's normal texture
mbCharacter:SetNormalTexture("Interface\\AddOns\\Deli_Ui\\img\\uimicromenu2x.tga")
-- Get the texture object and set its coordinates
local CharacterNormalTexture = mbCharacter:GetNormalTexture()
CharacterNormalTexture:SetTexCoord(2/256, 37/256, 324/512, 372/512)
-- Set the button's pushed texture
mbCharacter:SetPushedTexture("Interface\\AddOns\\Deli_Ui\\img\\uimicromenu2x.tga")
-- Get the texture object and set its coordinates
...
-- Set the button's highlight texture
mbCharacter:SetHighlightTexture("Interface\\AddOns\\Deli_Ui\\img\\uimicromenu2x.tga")
-- Get the texture object and set its coordinates
...
mbLatency:SetNormalTexture("Interface\\AddOns\\Deli_Ui\\img\\Latency.tga")
...
mbLatency:SetScript("OnUpdate", function(self, elapsed)
    ...
    if latencyHome < 200 then
      mbLatency:SetNormalTexture("Interface\\AddOns\\Deli_Ui\\img\\LatencyGreen.tga")
    ...
    elseif latencyHome < 300 then
        ...
        mbLatency:SetNormalTexture("Interface\\AddOns\\Deli_Ui\\img\\LatencyYellow.tga")
    else
        -- Latency is bad, set color to red
        --this.texture:SetVertexColor(1, 0, 0)
        mbLatency:SetNormalTexture("Interface\\AddOns\\Deli_Ui\\img\\LatencyRed.tga")
    end
end)
---------------------------------------------Latency Micro Button---------------------------------------------
