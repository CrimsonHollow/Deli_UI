...
f:SetScript("OnEvent", function()
    ...
    customMinimap.texture:SetTexture("Interface\\AddOns\\Deli_Ui\\img\\uiminimapmask.tga")
...
--Normal
tMinimapZoomIn:SetNormalTexture("Interface\\AddOns\\Deli_Ui\\img\\ZoomIn32.tga")
tMinimapZoomIn:SetWidth(16)
tMinimapZoomIn:SetHeight(16)
--Mouse over
tMinimapZoomIn:SetHighlightTexture("Interface\\AddOns\\Deli_Ui\\img\\ZoomIn32-over.tga")
--Mouse click
tMinimapZoomIn:SetPushedTexture("Interface\\AddOns\\Deli_Ui\\img\\ZoomIn32-push.tga")

tMinimapZoomOut:SetNormalTexture("Interface\\AddOns\\Deli_Ui\\img\\ZoomOut32.tga")
tMinimapZoomOut:SetWidth(16)
tMinimapZoomOut:SetHeight(16)
--Mouse over
tMinimapZoomOut:SetHighlightTexture("Interface\\AddOns\\Deli_Ui\\img\\ZoomOut32-push.tga")
--Mouse click
tMinimapZoomOut:SetPushedTexture("Interface\\AddOns\\Deli_Ui\\img\\ZoomOut32-push.tga")
...
MinimapClock.text:SetFont(customfont, 12, "OUTLINE")
